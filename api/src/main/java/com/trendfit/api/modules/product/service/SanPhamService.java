...
// api/src/main/java/com/trendfit/api/modules/product/service/SanPhamService.java
@Service
public class SanPhamService {
    ...
    @Autowired private DanhMucRepository danhMucRepository; // Phải khai báo
    ...
    // Lấy thông tin danh mục & thương hiệu để đổ vào <select> ở Frontend
    public Map<String, Object> getMetadata() {
        Map<String, Object> data = new HashMap<>();
        // Giả định bạn có DanhMucRepository và ThuongHieuRepository
